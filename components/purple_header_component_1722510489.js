...
Vue.component("purple_header_component_1722510489", {
    template: `
    <header class="w-full z-30 backdrop-filter backdrop-blur-lg bg-opacity-30 bg-gradient-to-r from-pink-500 to-purple-600" id="header-section-container">
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        <li><a id="Blockchain Analytics-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-white hover:text-pink-200" href="Blockchain Analytics.html">Blockchain Analytics</a></li>
                        ...
                        <li><a id="API Access-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-white hover:text-pink-200" href="API Access.html">API Access</a></li>
                ...
                <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                    ...
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                        <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5 bg-gradient-to-r from-pink-500 to-purple-600 bg-opacity-70 backdrop-filter backdrop-blur-lg">
                            <li><a id="mobile-Blockchain Analytics-link" class="flex font-medium text-sm py-1.5 text-white hover:text-pink-200" href="Blockchain Analytics.html">Blockchain Analytics</a></li>
                            ...
                            <li><a id="mobile-API Access-link" class="flex font-medium text-sm py-1.5 text-white hover:text-pink-200" href="API Access.html">API Access</a></li>
